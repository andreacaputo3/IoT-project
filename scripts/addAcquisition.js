...
module.exports = async function(callback) {
    try {
        ...
        const datetime = 1658144357; // Unix timestamp per una data/ora specifica
        ...
        await contractInstance.addAcquisition(datetime, registeredTemperature, hasProblems, transportId);
